              ...
              children: [
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'Autorise l\'assistant conversationnel à consulter '
                              'et piloter la machine via les outils ci-dessous.',
                              style:
                ...
                GlassPanel(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        'Flash Lite offre 500 requêtes/jour en gratuit ; les '
                        'autres modèles 20/jour. Chaque modèle a son propre '
                        'quota.',
                        style: TextStyle(color: fc.textSecondary, fontSize: 11),
                      ),
                      const SizedBox(height: 12),
                        ...
                        children: [
                          Expanded(
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text('Bascule automatique',
                                    style: TextStyle(
                                        color: fc.textPrimary,
                                        fontWeight: FontWeight.bold)),
                                const SizedBox(height: 4),
                                Text(
                                  'Passe au modèle suivant quand le quota du '
                                  'jour est atteint (429) — cumule les quotas.',
                                  style: TextStyle(
                ...
                const SizedBox(height: 20),
                GlassPanel(
                  title: 'PERMISSIONS PAR CATÉGORIE',
                  borderColor: fc.surfaceBorder,
                  backgroundColor: fc.surface,
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                      ...
                      Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            Expanded(
                              child: Text(
                                'La lecture de l\'état machine et l\'arrêt '
                                'd\'urgence sont toujours autorisés sans '
                                'confirmation, quels que soient ces réglages.',
                                style:
